...
document.addEventListener("DOMContentLoaded", function () {
  ...
  populateTable(
    "bestGrowingTable",
    cryptoData.sort((a, b) => b.percent_change_7d - a.percent_change_7d)
  );
  populateTable(
    "bestFallingTable",
    cryptoData.sort((a, b) => a.percent_change_7d - b.percent_change_7d)
  );
  ...
  document
    ...
    .addEventListener("input", function () {
      ...
      populateTable(
        "bestGrowingTable",
        filteredData.sort((a, b) => b.percent_change_7d - a.percent_change_7d)
      );
      populateTable(
        "bestFallingTable",
        filteredData.sort((a, b) => a.percent_change_7d - b.percent_change_7d)
      );
    });
});
